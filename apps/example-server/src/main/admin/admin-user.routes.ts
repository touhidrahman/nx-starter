...
import { approveAdminUserHandler, approveAdminUserRoute } from './routes/create-admin-user'
import { getAdminUserHandler, getAdminUserRoute } from './routes/get-admin-user'
import { getAdminUsersHandler, getAdminUsersRoute } from './routes/get-admin-users'
import { updateAdminUserHandler, updateAdminUserRoute } from './routes/update-user-admin'
