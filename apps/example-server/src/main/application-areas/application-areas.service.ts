...
import { InsertApplicationArea, SelectApplicationArea, zInsertApplicationArea, zUpdateApplicationArea } from './application-areas.schema';
...
async findApplicationAreaById(id: number): Promise<SelectApplicationArea | null> {
...
async createApplicationArea(data: InsertApplicationArea): Promise<SelectApplicationArea> {
...
async updateApplicationArea(id: number, data: Partial<InsertApplicationArea>): Promise<SelectApplicationArea | null> {
